...
describe AnecdotesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all anecdotes as @anecdotes" do
      ...
      expect(assigns(:anecdotes)).to eq([anecdote])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new anecdote as @anecdote" do
      ...
      expect(assigns(:anecdote)).to be_a_new(Anecdote)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created anecdote as @anecdote" do
        post :create, {:anecdote => valid_attributes}, valid_session
        expect(assigns(:anecdote)).to be_a(Anecdote)
        expect(assigns(:anecdote)).to be_persisted
      end

      it "redirects to the created anecdote" do
        post :create, {:anecdote => valid_attributes}, valid_session
        expect(response).to redirect_to(Anecdote.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved anecdote as @anecdote" do
        ...
        allow_any_instance_of(Anecdote).to receive(:save).and_return(false)
        post :create, {:anecdote => { "texte" => "invalid value" }}, valid_session
        expect(assigns(:anecdote)).to be_a_new(Anecdote)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested anecdote" do
        ...
        expect_any_instance_of(Anecdote).to receive(:update).with({ "texte" => "" })
        put :update, {:id => anecdote.to_param, :anecdote => { "texte" => "" }}, valid_session
      end
      ...
      it "redirects to the anecdote" do
        anecdote = Anecdote.create! valid_attributes
        put :update, {:id => anecdote.to_param, :anecdote => valid_attributes}, valid_session
        expect(response).to redirect_to(anecdote)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the anecdote as @anecdote" do
        anecdote = Anecdote.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Anecdote).to receive(:update).and_return(false)
        put :update, {:id => anecdote.to_param, :anecdote => { "texte" => "invalid value" }}, valid_session
        expect(assigns(:anecdote)).to eq(anecdote)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the anecdotes list" do
      anecdote = Anecdote.create! valid_attributes
      delete :destroy, {:id => anecdote.to_param}, valid_session
      expect(response).to redirect_to(anecdotes_url)
    end
  end
